...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 text-white bg-accent p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300 flex items-center justify-center z-50"
      aria-label="WhatsApp"
    >
      <svg
